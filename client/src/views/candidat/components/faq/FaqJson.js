export function faqJson (lineDelay, departements = [], parisCenters = []) {
  const returnArray = [
    ...
    },
    {
      ...
      content: [
        {
          textContent: `L’inscription à candilib se fait obligatoirement après réception d’un mail d’invitation envoyé par les services départementaux en charge de l’expérimentation. La priorité est donnée aux cantdidat·e·s qui sont en attente depuis plusieurs mois.`,
        },
        {
