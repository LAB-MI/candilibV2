...
const adminApiPaths = (isBuildWithAll || isBuildWithAdmin) && {
  ...
  lastInfosStatusCandidat: `${apiPrefix}/admin/last-infos-status-candidat`,
  ...
  techUsers: `${apiPrefix}/admin/tech-users`,
  techAutomate: `${apiPrefix}/tech/automate`,
  ...
  placesExam: `${apiPrefix}/admin/archived-places`,
}
