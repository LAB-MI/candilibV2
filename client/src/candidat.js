...
export default {
  ...
  recap_reservation_modal_annuler_body_with_penalty: `En poursuivant, votre réservation du {dateCurrentResa} et créneau initialement réservés sera annulée. De plus, étant à moins de {nbOfDays} jours de la date d'examen, un délai de repassage de {penaltyNb} jours s'appliquera à partir de la date de votre réservation annulée. Souhaitez-vous confirmer ?`,
