...
export default {
  ...
  messsage_mise_a_disposition_des_places_faq: 'Si de nouveaux créneaux sont ajoutés, ils seront mis en ligne à partir de midis.',
  messsage_mise_a_disposition_des_places: 'Votre horaire d’accès aux places d’examen est:',
