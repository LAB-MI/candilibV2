...
Si vous avez annulé ${config.daysForbidCancel} jours avant la date prévue, 
  ...
  Si vous avez annulé à moins de ${config.daysForbidCancel} jours de la date prévue, 
  un délai de repassage de ${config.timeoutToRetry} jours à partir de la date de réservation annulée, vous sera appliqué. 
